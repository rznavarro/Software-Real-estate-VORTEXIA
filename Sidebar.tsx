...
import { BarChart3, Home, Users, MessageSquare, Building } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, onSectionChange }) => {
  ...
  return (
    <>
      <div className="w-72 bg-gray-900 text-white p-8 min-h-screen">
        ...
        <div className="mt-12 p-6 bg-gray-800 rounded-2xl border border-gray-700">
          ...
          <div className="mt-6 pt-4 border-t border-gray-700">
            <button 
              onClick={() => setShowDetailsDashboard(true)}
      ...
      <DetailsDashboard 
        isOpen={showDetailsDashboard} 
        onClose={() => setShowDetailsDashboard(false)} 
      />
    </>
  );
};
